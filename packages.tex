...
\usepackage{wrapfig}
\setlength\intextsep{0pt} % ACHTUNG: might affect other float environments!
...
\hypersetup{
  ...
  filecolor=magenta,      
  urlcolor=blue,
  pdftitle={Schnupperstunde Mathematik},
...
\usepackage{amsthm} % loading order is important here!
...
\newtheorem{nrtheorem}{Satz(*)}[theorem]
